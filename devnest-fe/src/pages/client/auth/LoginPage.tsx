...
export function LoginPage() {
  ...
  //     console.log("Resend OTP to:", watch("email"))
  //   } catch (error) {
  //     console.log(error)
  //   }
  // }
                ...
                {mode === 'forgot' && forgotSent ? (
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-500 mb-4">
                      Kiểm tra hộp thư <strong>{data.email}</strong> để đặt lại
                      mật khẩu.
                    </p>
                    <button
                      ...
                      {mode === 'register' && (
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all ${errors.fullname ? 'border-red-300 bg-red-50' : 'border-gray-200 focus:border-transparent'}`}
                          />
                          {errors.fullname && (
        ...
        {showOtpModal && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-sm bg-white rounded-2xl shadow-xl p-8 relative"
            >
              {/* Close button */}
              <button
              ...
              <div className="flex justify-center gap-2 mb-4">
                {otpCode.map((digit, index) => (
                  <input
                    ...
                    className={`w-12 h-14 text-center text-xl font-bold rounded-xl border-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${otpError ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                    autoFocus={index === 0}
                  />
                ))}
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 disabled:bg-primary-400 text-white font-semibold py-3 rounded-xl transition-colors mb-4"
              >
                {isVerifyingOtp ? (
                  <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
                ) : (
